import { contactEmail, submitProjectSectionId } from '@/data/siteContent'
  ...
  return (
    <footer className="border-t border-slate-200/70">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-4 px-6 py-8 text-sm text-slate-500 sm:flex-row">
        <p className="text-xs font-medium uppercase tracking-[0.36em] text-slate-400 [font-family:'SFMono-Regular','Menlo','Monaco','Consolas',monospace]">
          REACTSTART
        </p>
